...
![img](./img/cd976e4788a44dc2ad53a9b8f9c4cf16~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/c758af8012c54113bea4083401b8c30d~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/eb6258bab20944799ba662d2fc519465~tplv-k3u1fbpfcp-zoom-1.png)

而 **CSS Flexbox 是一维布局，** 这意味着可以将元素按行或列排列，但不能同时按行或列排列：

![img](./img/9f54ec5b1e704cf29788e88e59884721~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/2cb4d2ba1a354555af832ccb8afad454~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/d74406ae887c4b90a9a5608cef1b2d62~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/68907bcf6e1c4c0ba01aa7d59e974ce0~tplv-k3u1fbpfcp-zoom-1.png)

> Demo 地址： https://codepen.io/airen/full/KKeoJoY

既然 CSS 网格可以用于构建一维布局，那么 CSS Flexbox 也可以用来伪造一个看起来像网格的布局，只不过 Flexbox 算法却不知道第二个维度。比如下面这个常见的页面结构布局：

![img](./img/735a6838de5e4a248cccee000e38095e~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/80453f3ad2954dd495de3437bf38e1d6~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/3968bb5046ce48adb6cbd291a569a8e7~tplv-k3u1fbpfcp-zoom-1.png)

最终实现的布局效果是相似的：

![img](./img/857f5b58fd1842de873538031366fa7c~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/f8b822b4916d47f3b5c0e2e4cf463713~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/791460baba704307a47270a1d50bb42c~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/7bfb9fb1d1e14a4a975422dfa1839010~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/32ca061278174015997d8bf7b51e67f1~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/a47d50b7b79a4a48922fd45bf9a740e0~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/ab8599da3eb44c268fbb3ff26a980212~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/658cd63736224a7395ad20e8984ee691~tplv-k3u1fbpfcp-zoom-1.png)

在不确定一个组件会在哪里放置的情况下，你需要确保组件可以随着环境调整布局。依旧拿卡片组件为例，你可能需要为同一个卡片小组件提供不同的布局：

![img](./img/6b3f8fde8e8e46889eae58fe90e78045~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/3cbf9bbb2c0149bba353265063a05a2b~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/4944314ec00a41bbb18575a31f2b2de1~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/4d511f3d440d49c69b51442c6d5c2ada~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/c3d91e407b5a4eb48c2a938f30888c01~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/3f16ef6be429487a972fa41b9a2a3b50~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/e06c2238149447c5943724c094460a75~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/4c6236fc2d2d4388a1d324587ab3ab33~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/28399ca35e834ab59dccfce7f2fad099~tplv-k3u1fbpfcp-zoom-1.png)

### 项目的伸缩扩展

CSS Flexbox 和 CSS Grid 布局中，Flex 容器和网格容器的直接子元素都被称为**项目** （Flex 项目和网格项目），它们都具备伸缩扩展的特性。

![img](./img/681b98a934f346d1ba9d7b8bab848a54~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/5b1a14bcdc594f39a60bd7fed1121189~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/257e799c91704c79a254820a8fc2809e~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/f108c3ea67354b889be6660ec2794994~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/0a0c5ad5b86f4390890db8ebcadc99dd~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/6ea35cf5c99d4d4282536aef5aab9df2~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/2eff76cdc0404d0d98f6a32b746b4e6e~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/074bd93a9c6c416a92c09b5bda09b25f~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/194c647811d04fc68f80bc86cd55207f~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/976ed0aa3eb54160ad77a95bdf6035be~tplv-k3u1fbpfcp-zoom-1.png)

**CSS Grid 效果** ：

![img](./img/6e8846a731924d12930fc32417be14de~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/3103734ca4bb414393470a53a1fa6b39~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/da865bae44ad4db1a170ffb0035fbb61~tplv-k3u1fbpfcp-zoom-1.png)

> Demo 地址：https://codepen.io/airen/full/dyKjyMv

有关于 CSS Flexbox 和 CSS Grid 主要的差异就介绍到这了，这里附上它们之间特性的对比图：

![img](./img/4b280751f69943b6946059e2e11bad88~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/ac8a3cdef4f2475e939f8cc960c82110~tplv-k3u1fbpfcp-zoom-1.png)
...
![fig-20-42.jpg](./img/b30df7b9c097464992209a55d3a95d98~tplv-k3u1fbpfcp-watermark.png)
...
![img](./img/4822b04e828b4c34b976ac8ef4eff889~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/19d62f97a9e94d86b16b16fcb817dd12~tplv-k3u1fbpfcp-zoom-1.png)

另外一个我更愿意使用 Flexbox 而不是 Grid 的原因是，如果我想创建一个设计，两个或多个元素水平对齐，其中一个沿着可用空间伸展，而其他元素保持其自然宽度。比如下图这样的场景：

![img](./img/9f3bd7001564439a949d85bc4841d6ac~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/187240bfae1d4cf6a081ad6160d3cc47~tplv-k3u1fbpfcp-zoom-1.png)

当你改变容器大小时，你将看到的效果如下：

![img](./img/894f8e39b97747cb8676b0095256b2ae~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/42193a8df55a47b5bf86749138b1c60d~tplv-k3u1fbpfcp-zoom-1.png)

> Demo 地址： https://codepen.io/airen/full/yLEqjVJ

虽然最终结果是一样的，但我认为 Flexbox 是更好的选择，原因是，如果你以后决定在搜索栏两侧添加更多的图标时，你不需要修改任何的 CSS 样式：

![img](./img/1ff61afcd9cc4d4089f910359c9ef22d~tplv-k3u1fbpfcp-zoom-1.png)

换作是 Grid 布局，虽然向搜索栏的右侧添加额外的图标，布局看起来还行，但向搜索栏的左侧添加额外的图标时，就会打乱原先的布局：

![img](./img/d47dbf4f783a4144ad9e78e5a5fd30e6~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/349303ec5b124e5a81930f7bd2ad9c62~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/d960f35d509c44198360d080f52b0108~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/c4903f159ebd4df6906084fc1331e2a9~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/4af13fa370694957b7a5ebd2312b771f~tplv-k3u1fbpfcp-zoom-1.png)

另外，就页面中导栏菜单和右侧的用户信息栏，我们可以使用 Flexbox 来布局：

![img](./img/0c0d88175c3c4f7b8a2790ee84c9da3b~tplv-k3u1fbpfcp-zoom-1.png)

这也是一个典型的 CSS Grid 和 CSS Flexbox 混合在一起使用的案例：

![img](./img/3c4b1c1b68a14276adb995a95a77cd5c~tplv-k3u1fbpfcp-zoom-1.png)

> Demo 地址：https://codepen.io/airen/full/NWYmQmB

卡片组件在 Web 中是另一个常见的组件。像下图这样排列卡片的布局也是到处可见：

![img](./img/1204f0df4d5142d888f6568af63ee443~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/c8de2d5fe271451b8dfa85534cf6e28c~tplv-k3u1fbpfcp-zoom-1.png)

> Demo 地址：https://codepen.io/airen/full/gOKjKQm

继续以卡片组件为例：

![img](./img/b6fb920592c24a47aa5401542be2d835~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/1482a9950e574cd5ad503031bde77e30~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/fcc68b136cdc42c6a997a62868f52c43~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/b45471af206143faa328e71f84f96b91~tplv-k3u1fbpfcp-zoom-1.png)

而且，你还会发现，新换行的卡片宽度会根据 Flex 容器的空间伸缩扩展：

![img](./img/6667f95ce006485182f53cc865f7d596~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/c16da7c0556842d1929da65b39e9eab4~tplv-k3u1fbpfcp-zoom-1.png)

> Demo 地址：https://codepen.io/airen/full/WNygGVx

另外，CSS Flexbox 有一个效果实现起来难度也是非常的大。比如说，每张卡片每个元素区域在垂直方向都要对齐：

![img](./img/1a0495856caa43cb950b3e022cde3c07~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/385e45217ac74f3db917ab12f892ceb9~tplv-k3u1fbpfcp-zoom-1.png)

最终你在支持 `subgrid` 浏览器中看到的效果是很完美的：

![img](./img/23a1df0f7e234a6c975bbeea4bca723a~tplv-k3u1fbpfcp-zoom-1.png)

> Demo 地址：https://codepen.io/airen/full/oNyPYXm

虽然 CSS Flexbox 能实现大部分 Web 布局，但也有不少布局是不太适用的，尤其是层叠类的布局：

![img](./img/f9ebed597017470f9afa7392cb2ecd6a~tplv-k3u1fbpfcp-zoom-1.png)

我们来看一个层叠方面的示例：

![img](./img/f20acb2f1798436f82d0f8f08ff7b5d4~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/bec2186c052d46279522a0950a4fd77e~tplv-k3u1fbpfcp-zoom-1.png)
