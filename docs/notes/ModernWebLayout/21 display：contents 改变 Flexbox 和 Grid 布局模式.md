...
![img](./img/514973f508d341c6878f41b4237603e7~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/7d5ce7709aa44094a71d8a1db7799dfc~tplv-k3u1fbpfcp-zoom-1.png)

我们可以通过 CSS 的 `display` 属性将任何一个文档流做出改变，如下图所示：

![img](./img/a3a2a0dd076b46f39cfc71d176c25acc~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/36affa3c16de4ebbbb4685c61454a35e~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/36baad87ff4b4b4285a29b66294d3c32~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/0cd4f94f6b434d189ff11cf85966650b~tplv-k3u1fbpfcp-zoom-1.png)

你会发现， `section` 元素的 `display` 属性值为 `contents` 时，该元素自身的样式规则就像是被丢失或禁用了：

![img](./img/cbfeb9282a604d56a27f492d830b8ef5~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/0fdc3c4c15014b9785ca8dbbf9d192b5~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/d2516f67430a4206b4681c618b1c93e8~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/bc842e7cc48e409c8e106bfb54f4d644~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/c0aada3157d145c4bd7485127f2bef74~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/c885c4d8c0714bc99ab7ccd44472cc0e~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/6b21717c9b764362b74d1dfaf09f92c3~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/471eacdcb8054593b8283ce2c43d8bb7~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/0ef88f0646144bc285bbb4a3683fe215~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/39f571e2e7da4fe0ac38ebc992efc534~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/22c47d81a3ab49db96c0b8d9c0412c47~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/6a8899d60fb547bfac5610fb1fe8fa94~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/f5691051057c42bfb4eda472735f30f7~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/4b4601e491294f13bea88423ce745d68~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/566b3de16f3b4a28a87fc6255c13100b~tplv-k3u1fbpfcp-zoom-1.png)

CSS 网格布局中的 `subgrid` （子网格）非常适用于表单中 `<label>` 、`<input>` 和 “验证信息” 几个部分的布局。

![img](./img/d720711da97d4ba4916ce1914a4b27d5~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/e2c989660fd34190a51a526fd25d50c7~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/1c3c1a49aae44069b224280dcbe6e5dd~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/0188c7c18120410098ca0f09554fb481~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/0f621f2aa2fc4b019b72109e0b788b19~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/de4dfd5823dd4e18914c3f2795bd92b6~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/24897400a3954c3ca753f968732b770d~tplv-k3u1fbpfcp-zoom-1.png)
