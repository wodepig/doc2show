---
title: 18 使用 Grid 构建经典布局：10 种经典布局
author: Your name
createTime: 2024/07/29 21:23:47
permalink: /ModernWebLayout/we7a11z5/
---
...
![img](./img/dc025513ebcb4cb19e56ceb4d1ebc45f~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/e348e281c2e744ac880b946bdd126331~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/fc074c665d064187ab48e3e9d2d734be~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/8c88eb64fae048d5886fa1fc64b44671~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/85e974e849d1402e9476a3e03afa0fd4~tplv-k3u1fbpfcp-zoom-1.png)

> Demo 地址： https://codepen.io/airen/full/gOKRWOa

通过前面课程的学习，我们知道，在网格项目上设置 `margin` 的值为 `auto` 时，也可以控制网格项目在内联轴和块轴方向的对齐方式：

![img](./img/812c3786af84481b8a0820c500ae0c60~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/cb8a4517a8914cf7bbd39d5dfc1bb044~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/42dc08f358e748cb8e1ea8596e6aaf07~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/248f52e462ca442bb97aa59427a64706~tplv-k3u1fbpfcp-zoom-1.png)

虽然视觉效果不符合预期，但这并不代表着渲染错误。在 CSS 网格布局中，它的表现行为是正确的，使用浏览器调试工具查看，你会发现整个网格已经实现了水平垂直居中：

![img](./img/baa59f94d8b748e3a604c0072ff0336e~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/6909e96a22194067a9a232f237d21898~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/c5d8cd82b81d40e1b0d8c4586491c743~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/2bba71d0afca4f08a228f5d1d0cb5627~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/20e365d8374d49b69b8c18c9c23b7b7a~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/213b1cb8415147c3985ce42ec04c73cc~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/6c8b32735e3b4646ac3b51fded10f00c~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/6eb9b946c5e2492b96268ec286efda3c~tplv-k3u1fbpfcp-zoom-1.png)

从上图中你会发现，每张卡片标题内容高度不一致，导致其他元素无法在同一水平线上对齐，这可能不是设计师所期望的一个效果。设计师可能更期待的效果如下图所示：

![img](./img/8009947c6e7c4d7bb7a0fb5c37ff3fae~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/bb2b7842343045e0bcf81904a0e62b20~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/930538e34f7545d09a1739b67286f50f~tplv-k3u1fbpfcp-zoom-1.png)

类似上图这个效果的示例，在我们小册中出现多次了，在小册的其他课程中详细阐述过，这里就不再花篇幅来介绍示例中布局的相关代码了。你在支持 CSS 子网格的现代浏览器中将看到的效果如下：

![img](./img/462f507ef4274f40989e10d2e0517d53~tplv-k3u1fbpfcp-zoom-1.png)

> Demo 地址： https://codepen.io/airen/full/RwJgXpe

即使是在不支持子网格的浏览器中，它的效果也不会太差，与 Flexbox 实现的效果等同。

![img](./img/3bec8eb18ddd41e4ac445256f7b4f74b~tplv-k3u1fbpfcp-zoom-1.png)

**作业** ：使用 CSS 网格构建下图的布局效果：

![img](./img/f0313d6dbb68410989619f0aaf52c926~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/c8dc3fbdce6842dcaf40bb7fb84fbd33~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/98b0127f71304bfc97a64e7ed2346e8b~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/0e76431660014fc283cde803d6edad87~tplv-k3u1fbpfcp-zoom-1.png)

但这种布局也是有缺陷的，当网格容器小到一定程度时，比如小于所有网格项目最小内容总和，网格项目就会溢出网格容器，或者会出现水平滚动条：

![img](./img/94753a7c308144c9b73d19e9297aa5ef~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/19e5cbfdc5df4781ae08ec65e93d9661~tplv-k3u1fbpfcp-zoom-1.png)

> Demo 地址： https://codepen.io/airen/full/JjZyGNO

**作业** ：请使用 CSS 网格实现下图中等宽表格：

![img](./img/66ed7a4fe75149b79433afa63449623b~tplv-k3u1fbpfcp-zoom-1.png)

## 圣杯布局

Web 网站开发最经典的设计之一被称为“**圣杯（Holy Grail）**”。它的最大特色就是包含了“页头”、“页脚”和三列，并且以内容先行为设计原则。

![img](./img/840eb32f0ad34f3aafbaf2210245e62e~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/47a6322fdcfa4860a9ab3d1bb7fa6466~tplv-k3u1fbpfcp-zoom-1.png)

*facebook.com* 

![img](./img/6cca5ae0c7b84b60a95f4ea679a4beda~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/d452bca8f2924526a75440417780109e~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/72781c9df04e44ec9f3bea38a0cdea98~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/eb4cb1804496430cac671aa3290773fb~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/647ab85722824fcda98f80a9c6a4c00a~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/7d1216accd094628ac92c00e069bf8c7~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/9dc15a35008f4e9c8e3907f348cc8b6d~tplv-k3u1fbpfcp-zoom-1.png)

这样就有了下图的效果，调整浏览器视窗宽度，你可以看到平板端和移动端两个不同断点下，圣杯布局的差异：

![img](./img/90ccf58c9b0247bba104f0ad2da6608f~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/d78e598f731f475599eb6462143d866e~tplv-k3u1fbpfcp-zoom-1.png)

这样就完了一个终级版的带有响应式的圣杯布局：

![img](./img/05e1f0e6be3541fb9e2559207b3f582e~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/00d6f1188c3541fe8092810e62647115~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/a3d358b987e44096b0e5167fb91d3463~tplv-k3u1fbpfcp-zoom-1.png)

> Demo 地址：https://codepen.io/airen/full/wvXqYjo

**作业** ：使用网格布局，构建下图的布局效果，去掉页脚区域的圣杯布局：

![img](./img/d540d0f339964d1887a6837d1f8f1781~tplv-k3u1fbpfcp-zoom-1.png)

## Sticky Footer 布局

![img](./img/7c7759b32a554c6fbbfdcf961e332723~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/bc3be1d8e5374ae7863f3e5761ae510f~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/35eb6b85ac124688b09f44224470e535~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/d00122f7a144439ab9ecab9303da2f02~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/560889f099f2422d937e36326a206299~tplv-k3u1fbpfcp-zoom-1.png)

另外，网格对齐属性对 `auto` 计算值也是有影响的，如下图所示：

![img](./img/e602e6d425234980b06778a43652b9e4~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/d53d1dddf0c640d1ad990052b3cae2a0~tplv-k3u1fbpfcp-zoom-1.png)

这就是制作 Sticky Footer 布局时，为什么使用 `auto` 和 `minmax(0, 1f)` 能达到相同的效果。

![img](./img/28eee28384b84c81a61459a1a1f88cdb~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/9d9495f069df4b1ba85fad7d803d1549~tplv-k3u1fbpfcp-zoom-1.png)

> Demo 地址： https://codepen.io/airen/full/LYrzeMe

另一种布局效果拿移动端的页面布局为例：

![img](./img/55be553dfbde459a8489e7d7f68745dc~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/2567d2f9d2e74096a28b2df44674d57c~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/a5c7880395fd41e5bf43ba9da0db015a~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/04c5b8802e304f759aaea1f5a2160908~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/c8f6576ec89941b3b98c23af17f86993~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/9325facfd57140bb98cb26de565b80e5~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/1cffdc75b50647d38b6f004b04b25e9c~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/60074c0844bd4809ab7ef3d9ab85fe56~tplv-k3u1fbpfcp-zoom-1.png)

## 九宫布局

![img](./img/9d7f49b251c0462287d69ddcfd7ee578~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/193744fcb27542cd8ec49302846b7cfb~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/c92e50dd322c4ff3a6e3d99e56f8f9d1~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/721f2a82b80144f7b5ea151829b4707f~tplv-k3u1fbpfcp-zoom-1.png)

**作业** ：请使用 CSS 网格构建下图布局：

![img](./img/18935d3b673f4d9aa780f05c4cfda2a1~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/0fd8456425794e2cb56196119b842efc~tplv-k3u1fbpfcp-zoom-1.png)

同时，我们也知道 Flexbox 布局中使用 `flex: 1` 也能让 Flex 项目根据 Flex 容器的空间自适应，但是 Flexobx 布局时，Flex 容器小到一定程度时，其他 Flex 项目会因空间不足而受到挤压（Flex 项目被收缩）：

![img](./img/ed879b03611b4f2fac34200ac63283ac~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/07138a7313a64c3ea254ed46beb80e88~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/c03ef119ae7a40d495edf688b0030b63~tplv-k3u1fbpfcp-zoom-1.png)

> Demo 地址：https://codepen.io/airen/full/oNyGPww

上面示例是长文截取的一个常见案例，CSS 处理这种场景已有很成熟的解决方案了。除此之外，还有对列表项截取的场景，如下图所示：

![img](./img/b33e1781bc544d46aa459cd4839b0685~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/3d85e689716e46c3988c91c65923fa20~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/5e813a044da046e693207541ddced0d0~tplv-k3u1fbpfcp-zoom-1.png)

> Demo 地址：https://codepen.io/airen/full/dyKZObm

## 宽高比布局

![img](./img/b17a3db9271f4885ac31f83c74133514~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/e4145414d8504815b4de4d00bedc2d50~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/4b1b1e12bfc247fdbcbe760769bf8a1f~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/75d5cd41855147dbaa4fd05bbe598ad1~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/6386afaadb2645fcad9152dca52d48b0~tplv-k3u1fbpfcp-zoom-1.png)

看上去是不错，网格项目符合宽高比的布局。但网格不可能永远是一行多列的，它也会有多行，这才是我们更需要的网格。可是，当有多行出现，并且网格项目宽高比也不同时，网格又将会被打破：

![img](./img/84ffd6ae3df54dcb84b4d784397c20c9~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/1c7a86a7aed845f19e17a50942755d28~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/df76173352df46d78739b351c9d7d4cc~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/23845280a9be478785f777813f92e5e7~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/cd50b36d4034434da314e87dafa54065~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/b04b50a8fc694eb6ab140eb71a11d256~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/ed1e42108f7a4bd1834a4f1dcac76511~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/5edff371fb0644d99f4b34dd2dcfaccb~tplv-k3u1fbpfcp-zoom-1.png)