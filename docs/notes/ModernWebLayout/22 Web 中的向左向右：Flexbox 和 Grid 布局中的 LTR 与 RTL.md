...
---
![img](./img/7fe85803de6642a5b6a04f00b0993c1f~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/44e446f56a2a4b5384e73ab0407d2e26~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/312fadea1a5e4073a767f388e7a66f21~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/43654b83eef84c239e5caac0e48dbfd5~tplv-k3u1fbpfcp-zoom-1.png)

如果你查看过其源码的话，你会发现在 `<body>` 元素上设置了 `dir` 属性，同时在 CSS 中设置了`direction` 属性：

![img](./img/2d0273d8cf194385bcabb69adcf0d52a~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/2b5c49d4bfc445d9906e5b7979a9c1b7~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/5f6e4d1300024052a1535bf143937a47~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/dd7f2172a6ef45f18dffac117ca97fdb~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/8cf6994c962748d3992131327f113adf~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/ad0ae376b5ac416c8c179b11509f51c7~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/b461e92d3c6241588427e1744e87a8b7~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/06c149cf100a49ca95e7bdb0782cecf9~tplv-k3u1fbpfcp-zoom-1.png)

为了更好地展示 LTR 和 RTL 在翻转设计上的差异，我们把事情缩小一些，就拿最典型的一个模块来举例，即媒体对象（Media Object）：

![img](./img/3bdef22949ca445d9b3d265fb9c23927~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/716431447a104dc19a72a00e81efd34f~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/d6127ec895434157a7ae5450280da5f6~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/c8b5e3b8bf9b40c99291bdc78f546289~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/c1e13e9d1084456ca241982d8eded2f7~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/09b5415973de4454bfd7d605c36f4ae7~tplv-k3u1fbpfcp-zoom-1.png)

就上图而言（默认是 LTR），对于一位阿拉伯语的用户来说，阅读起来是痛苦的，因为排版很混乱。它的读取顺序如下图所示：

![img](./img/cbcf59f6b38046f0bde513ae3d39ce70~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/7a33cc29354e4191b01c36920dda747c~tplv-k3u1fbpfcp-zoom-1.png)

对于混合排版的场景，我们还可以显式地给 `dir` 设置属性值为 `auto`。这样可以由用户代理（比如浏览器）来决定方向。它在解析元素中字符时会运用一个基本算法，直到发现一个具有强方向性的字符，然后将这一方向应用于整个元素。

![img](./img/6a651a72eec648c4ba3c7e942cff54f5~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/88fed7100532488b9e1449c253f34cdf~tplv-k3u1fbpfcp-zoom-1.png)

> Demo 地址： <https://codepen.io/airen/full/poKqOoK>

这里所说的块流和文本流，主要指的是 HTML 块元素的流动方向和文本内容的流动方向，其中文本流也常称“内联方向”：

![img](./img/8fb3d1483ced4e9f91eb143d228199b5~tplv-k3u1fbpfcp-zoom-1.png)

在 Web 中除了文档有流方向一说之外，对于文本同样有流的概念，比如说英文，一般是从左到右，阿拉伯文是从右到左，而日文（古代的中文）从上到下，从右到左：

![img](./img/a05873bc3dd4409ba36cee911eb3e338~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/f2ae56cb1f094ce9aa2fdc00702d637c~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/a2810f49556f4a82bb065666f5a85bcd~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/f549ea3458834984a1cd82797b98dfa6~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/775aa7a121834eb380ed7dc450bacaae~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/630cafe59bd34c2d9e7e10da90523857~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/57d642bbcc9a419e9b46a02578639404~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/6da342e400a3430e976fc503bf1e7ed2~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/91670e8b5d2c4143b1b389368ec987ba~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/361d9aa77108497eb12a36f1370ad4a6~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/9b91af72f9e0482e8ab517462c007a41~tplv-k3u1fbpfcp-zoom-1.png)

CSS 物理属性和逻辑属性之间映射关系，更详细的如下图所示：

![img](./img/4575cc9f4e934048945c56a7be38da1a~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/514b368392844fe38b2a57ddec49f48d~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/d41a7eeb41f244f98331e2d4af12e167~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/359d531bbaca42cf9d514c5980e0159c~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/05a4539626f84dff884713b87a5547f5~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/7881e640db8b4e5fbcf181315fa1413b~tplv-k3u1fbpfcp-zoom-1.png)

特别是进入到 CSS Grid 的时代，方向性更不重要了。因为在 Grid 的时代变成了：

![img](./img/141ce180c8fe4739ad9f13a18e5cc3ab~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/49533eb13b3a496c9e1789119922d1e3~tplv-k3u1fbpfcp-zoom-1.png)

了解 Flexbox 的同学都知道，在 Flexbox 容器中有一个 `flex-direction` 属性，在主轴方向（Main Axis）有两个属性值 `row`（默认值）和 `row-reverse`。

![img](./img/97eb7e4938c345499f1dd935e12d99ed~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/2753aae3c83d4d4e813e925b278f7442~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/0fadcf12f55841b7a363c6e5271c69d8~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/2cb13870d43f41d0b2f2e698ba8608a3~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/5d75f3609c0e438fb91569f0a779f4bb~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/f3823bd3b33c420ea300828595ee87b3~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/0d2091ea03e648579708d5346f5a21b1~tplv-k3u1fbpfcp-zoom-1.png)

针对这种情况，需要在竖排模式下，`flex-direction` 从默认值 `row` 更换成 `column` 。有关`writing-mode` 、`dir` 对 `flex-direction` 取值的影响如下图所示：

![img](./img/7fed663371024f1785131318fd8eda68~tplv-k3u1fbpfcp-zoom-1.png)

> Demo 地址：<https://codepen.io/airen/full/gOKEavY>

来看一个简单示例：

![img](./img/b70242f85a66428097d576db7fbed1a2~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/1516e879d6d84ba389db5c740d4833ea~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/78f40113b0e04576ae88f5a91299ee71~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/5afc164432f24b06bbd60ad1c1b1d29a~tplv-k3u1fbpfcp-zoom-1.png)

我们一起来看一个有关于 Logo 的布局设计，它是使用 CSS Grid 和 `writing-mode` 结合的案例：

![img](./img/7cefddeae48946e48330276684a74053~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/08cb604f650747ceab9e439a3cc8e192~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/a85d3b3e41bd445fa60341dc28ac4810~tplv-k3u1fbpfcp-zoom-1.png)
