...
![img](./img/6506afa00fb24ea4962a8a405d9214ae~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/5051c38527134bf1ac80db92bce29dc4~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/32ae9d9096d2452c967c0d3695aa2aab~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/29de11280da544deb136b24931bfc988~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/62f1715ef32a48f7b8fa6af7683fbd52~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/9721b060a92e4a889f7298201895941a~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/2f1660363d6d479ab34a653ff28d7827~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/fae8209441a349d19a6b349599030744~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/bdac1316f6684703a12154ecbeaf5de9~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/cb51162ad5794dfa9f47c9cd2eb32ecf~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/5bfad31c916a47ab9f5d36850434d955~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/6672195f9f70492ab9e73dd3cbe51628~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/b17c3fbd8f7c44fd801a41c73dfbec29~tplv-k3u1fbpfcp-zoom-1.png)

但现在的 m.taobao.com 已经取消了最大宽度的限制：

![img](./img/51726fdaa0d048a898ecc301a88d67cd~tplv-k3u1fbpfcp-zoom-1.png)

另外在一些大屏幕下（比如，京东），页面的呈现是有一定缺陷的：

![img](./img/fdc75130a604424383f70a8f01f25de8~tplv-k3u1fbpfcp-zoom-1.png)

这就是 REM 适配布局带来的一定缺陷。

相对而言，VW 比 REM 更易于适配百分百的屏幕，比如：

![img](./img/4dbc8ea50f9c4b0591c4485ccc4f7799~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/b9766cadf8cc462f869caf94e474e597~tplv-k3u1fbpfcp-zoom-1.png)

即使没有最大宽度的要求，在宽屏的时候，页面上一些组件 UI 也会有一定的缺陷，比如弹框：

![img](./img/f7c7e435af3a4b6b98f1a35b8cb488ac~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/6f103c7fc5b0401d98217d5aa1c6cd83~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/426730e281d54b008da35063492ead24~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/b067e7b1a64c41a8bf08a08d7a65c8a0~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/8105685c5d674d8b9e9cccd9f0dda275~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/3e60c9e541a74c4a89b49962e6f86db8~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/eb0efaf264e54349b282902cd947507c~tplv-k3u1fbpfcp-zoom-1.png)

但现在或不久的将来，会像下面这样针对不同的场景来做设计：

![img](./img/1ff2bb39a71449348a57564c072db825~tplv-k3u1fbpfcp-zoom-1.png)

拿实际案例来说吧，在响应式设计中，希望在不同的终端上，文本的字号有所不同，那么就可以像下面这样使用：

![img](./img/f0f17fc9ab074d1580bc8c7829e9739b~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/1b23600910094e1f8f3182624f5c1f00~tplv-k3u1fbpfcp-zoom-1.png)

> Demo 地址：<https://codepen.io/airen/full/zYLGpjg>

再来看另一个两列布局示例，比如：

![img](./img/30f5567eb681461496b577dc0e3aa68b~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/239b2d70c7464a28983ac5cd675a8a75~tplv-k3u1fbpfcp-zoom-1.png)

> Demo 地址： <https://codepen.io/airen/full/ZEjGvPd>

不知道你有没有发现，让浏览器视窗宽度小于 `320px` 的时候，页面的布局还是不够完美的。即：

![img](./img/ccd96a0c4ead441cb5e561d55593e3e6~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/05aedcd95d2149c28c1b177b57bd18f0~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/8b71d51612a144fc8066dbf5bbaa9cb7~tplv-k3u1fbpfcp-zoom-1.png)

> Demo 地址：<https://codepen.io/airen/full/abjOxBx>

虽然上面的效果已经不错了，但还是没法在指定的视窗断点下显示具体的列数。有意思的是，我们可以使用 `clamp()` 来实现该效果：

![img](./img/bc391ef5063448bca3507a5343b61001~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/7ac525a1011d40cd82aae5d7c49c0316~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/10905aaaf3864ec2ba5bb8aa83517c27~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/db9a95d633764efaa3d0c93ea4e26a88~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/ec8e1de69aff4e4f81855bfc32925cfb~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/8ab7c6d157bd466eb3ca67df9c082851~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/48f7c6276b8d4aeea0166f54bb562593~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/9f93137aeb78418eafa0af3cde25608f~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/c03621062a9b413aa122e4afe65860ff~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/a8d123bbcc7e49ccbf1ebd7b0e6d41dc~tplv-k3u1fbpfcp-zoom-1.png)

> Demo 地址：<https://codepen.io/airen/full/ExpVgeq>

同样的原理，要实现更多的列响应，只需要新增断点和 `clamp()` 的嵌套，比如前面我们说的 `P ▶ O ▶ N ▶ 1` 的列响应：

![img](./img/ede875d6865245a0b34a424e6c53bf6d~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/388d690f42b941878a7416fd81c89a39~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/039ac58776eb4f8995f6390e58876cb4~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/c0136090e5d743b98df51a6eef27e625~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/ff626029a2fa4e7392950a47aceb5138~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/72a90ff808c84657884f18428250676a~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/b64818f07194416db2be6d7d48fe16c0~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/86bde0372fa4451db32687a322f541f1~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/48bcd2f53ae9491f9b49646cf8814b97~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/76a3836fb5ff43cda99335eed9614149~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/13507848e6df4bf19864f1187af95bb0~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/48199281f88844ebb094f17a3d6b3852~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/3471aad7f5da4ed69ee5fed69e206d7d~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/5cfdc5bca7d34298b3ccdffd3c32fd18~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/39a04a8cb7144da989226bf05e7b8053~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/4615ab205aef4d7d86e81a183b608d01~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/57c8e06b254d40a9803bde8b70abd0c0~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/a4a02af9cf9845cb8f528a241965b396~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/7ea8f816f4a940f9a194a8a7b18cb5a6~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/1f9b895113804e22bfb92015abc99ba8~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/fd483f587eb14b2094d8fae6410ea133~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/ab062231aad84995b5d2e801c4849cc1~tplv-k3u1fbpfcp-zoom-1.png)
...
![img](./img/b8faba83e7b54fba91a82d8a4bf5cf00~tplv-k3u1fbpfcp-zoom-1.png)

> Demo 地址： <https://codepen.io/airen/full/xxJZGPV>

我们再来验证一下，上面示例在真机上的效果：

![img](./img/78bf0d20d9f34e86a26fd0df7e80b591~tplv-k3u1fbpfcp-zoom-1.png)
